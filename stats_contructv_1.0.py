...
class Project:
    ...
    def __init__(self, name: str, author: str, course: str, dataset_path: Optional[str] = None):
        ...
        Parameters:
            ...
            dataset_path (str, optional): Path to the CSV dataset file.
        """
        self.name = name
        self.author = author
        self.course = course
...
if __name__ == "__main__":
    # Creating a project with a dataset from a CSV file
    my_project = Project("Statistical Analysis", "Tyrone", "Data Science 101", "data.csv")

    # Print project summary
    print(my_project.get_summary())

    # List available methods
    print("\nAvailable Methods:", my_project.list_methods())

    # Execute statistical and visualization methods
    column_x = "age"
    column_y = "salary"

    print("\nCorrelation:", my_project.execute_method("correlation", column_x, column_y))
    print("Linear Regression:", my_project.execute_method("linear_regression", column_x, column_y))

    # Plot normal distribution
    my_project.execute_method("normal_distribution", mean=50, std_dev=10, size=1000)

    # Scatter plot between age and salary
    my_project.execute_method("scatter_plot", column_x, column_y)
